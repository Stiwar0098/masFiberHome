...
public class AdapterHistorialServicios extends RecyclerView.Adapter<AdapterHistorialServicios.ViewHolder> implements View.OnClickListener, View.OnLongClickListener {
    private List<HistorialServicios> lista;
    private View.OnClickListener listener;
    private View.OnLongClickListener listenerLong;

    public AdapterHistorialServicios(List<HistorialServicios> lista) {
        this.lista = lista;
    }
    public void setAdapterItemBuscarServicios(List<HistorialServicios> lista) {
        this.lista = lista;
    }
